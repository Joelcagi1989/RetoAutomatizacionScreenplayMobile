...
public class RealizarMultiplicacion implements Task {
    private List<TestDataModel> data;

    public RealizarMultiplicacion(List<TestDataModel> data) {
        this.data = data;
    }
    ...
    public static RealizarMultiplicacion de(List<TestDataModel> data){
        return Tasks.instrumented(RealizarMultiplicacion.class, data);
    }
}
