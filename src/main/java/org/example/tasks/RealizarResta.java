...
public class RealizarResta implements Task {

    private List<TestDataModel> data;

    public RealizarResta(List<TestDataModel> data) {
        this.data = data;
    }
    ...
    public static RealizarResta de(List<TestDataModel> data){
        return Tasks.instrumented(RealizarResta.class, data);
    }
}
